...
let githubLink = "oscarftoro/oscarftoro/LCI"

// Specify more information about your project
let info =
  [ "project-name", "LCI"
    "project-author", "oscarftoro"
    "project-summary", "a dsl to express First Order Logic expressions"
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/LCI" ]
