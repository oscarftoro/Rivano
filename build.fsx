...
let summary = "a dsl to express First Order Logic expressions"

// Longer description of the project
// (used as a description for NuGet package; line breaks are automatically cleaned up)
let description = "a tiny dsl"

// List of author names (for NuGet package)
let authors = [ "oscarftoro" ]

// Tags for your project (for NuGet package)
let tags = "logic dsl"

// File system information
let solutionFile  = "LCI.sln"
...
let gitOwner = "oscarftoro"
let gitHome = sprintf "%s/%s" "oscarftoro" gitOwner

// The name of the project on GitHub
let gitName = "LCI"

// The url for the raw files hosted
let gitRaw = environVarOrDefault "gitRaw" "lci/oscarftoro"
...
let builder (target : string) =
  ...
  let srcPath = __SOURCE_DIRECTORY__ </> "src/" </> projectName
